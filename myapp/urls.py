...
from .views import UserRegistrationView, UserImageViewSet, PostDetailView, DeletePostDetailView
from . import views
...
urlpatterns = [
    ...
    path('delPosts/<int:pk>/', DeletePostDetailView.as_view(), name='delete-post-detail'),
]
